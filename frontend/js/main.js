...
function updateAuthSection() {
    ...
    if (Store.isAuthenticated() && user) {
        authSection.innerHTML = `
            <div class="user-menu">
                ...
                <div class="user-dropdown" id="userDropdown">
                    ...
                    <a href="orders.html"><i class="fas fa-shopping-bag"></i> Buyurtmalarim</a>
                    ${user.role === 'seller' ? '<a href="seller.html"><i class="fas fa-store"></i> Do\'konim</a>' : ''}
                    <hr>
        ...
        authSection.innerHTML = `<a href="login.html" class="btn btn-primary">Kirish</a>`;
    }
}
